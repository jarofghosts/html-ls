...
test("streams dirs first when specified", function (t) {
  ...
  stream = htmlls(path.join(__dirname, "test-htmlls"), {
    showUp: true,
    dirsFirst: true,
  })
...
test(".. is configurable", function (t) {
  ...
  stream = htmlls(path.join(__dirname, "test-htmlls"), { hideDot: true })
...
test("configurable transforms", function (t) {
  t.plan(8)
  ...
  stream.on("data", function (data) {
    ...
    switch (step) {
      ...
      case 1:
        ...
        break
      case 2:
        t.equal(data, child("li", "lola.txtlol", "rofla.txtrofl"))
        break
      case 3:
        t.equal(data, child("li", "loldir/lol", "rofldir/rofl"))
        break
      case 4:
        t.equal(data, child("li", "lolfile.txtlol", "roflfile.txtrofl"))
        break
      case 5:
        t.equal(data, parent("ul", true), "closing tag")
        break
